    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    return [4, auth_1.randomMouseMovements(waPage)];
                case 6:
                    _a.sent();
                    return [2, waPage];
            }
...
function initBrowser(sessionId, puppeteerConfigOverride) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, puppeteer.launch(__assign({ headless: true, devtools: false, userDataDir: path.join(process.cwd(), sessionId || 'session'), args: __spreadArrays(puppeteer_config_1.puppeteerConfig.chromiumArgs) }, puppeteerConfigOverride))];
                case 1:
                    browser = _a.sent();
                    return [2, browser];
            }
